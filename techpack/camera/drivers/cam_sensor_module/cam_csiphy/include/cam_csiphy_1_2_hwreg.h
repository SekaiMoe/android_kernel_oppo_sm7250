...
#ifdef VENDOR_EDIT
	.csiphy_common_array_size = 10,
#else
	.csiphy_common_array_size = 6,
#endif
#ifdef VENDOR_EDIT
	.csiphy_reset_array_size = 8,
#else
...
struct csiphy_reg_t csiphy_common_reg_1_2[] = {
	...
	/*shitianyu@camera modified for bug 2485624*/
#ifdef VENDOR_EDIT
	{0x0158, 0x00, 0x01, CSIPHY_RESET_POLL_REG, 0xFF},
	{0x0358, 0x00, 0x01, CSIPHY_RESET_POLL_REG, 0xFF},
	{0x0558, 0x00, 0x01, CSIPHY_RESET_POLL_REG, 0xFF},
#endif
};
...
csiphy_reg_t csiphy_2ph_v1_2_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		#ifdef VENDOR_EDIT
                /* chengqiangwei modify reset failed cause camera blocked, case:04289829*/
	...
	},
	{
		...
		/*{0x071c, 0x52, 0x00, CSIPHY_DEFAULT_PARAMS},*/
...
csiphy_2ph_v1_2_combo_mode_reg[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		...
		{0x0024, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0008, 0x10, 0x00, CSIPHY_SETTLE_CNT_LOWER_BYTE},
		/*tianke@camera modified for case 04301653*/
		/*{0x000C, 0x00, 0x00, CSIPHY_DNP_PARAMS},*/
		/*shitianyu@camera modified for bug 2485624*/
		/*{0x0010, 0x52, 0x00, CSIPHY_DEFAULT_PARAMS},*/
		/*shitianyu@camera modified for bug 2485624*/
...
#ifdef VENDOR_EDIT
struct csiphy_reg_t
csiphy_2ph_v1_2_combo_mode_reg_r2[MAX_LANES][MAX_SETTINGS_PER_LANE] = {
	{
		{0x0030, 0x00, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x002C, 0x01, 0x00, CSIPHY_DEFAULT_PARAMS},
		{0x0034, 0x0F, 0x00, CSIPHY_DEFAULT_PARAMS},
	...
	.data_rate_settings = {
		{
			...
			.csiphy_data_rate_regs = {
				...
				/*{0xBB4, 0x21, 0x00, CSIPHY_DEFAULT_PARAMS},*/
				/*shitianyu@camera modified for bug 2485624*/
